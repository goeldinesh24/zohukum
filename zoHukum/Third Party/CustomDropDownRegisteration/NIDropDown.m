...
- (id)showDropDown:(UIButton *)b :(CGFloat *)height :(NSArray *)arr :(NSArray *)imgArr :(NSString *)direction {
    ...
    if (self) {
        ...
        if ([direction isEqualToString:@"up"]) {
            self.frame = CGRectMake(btn.origin.x, b.superview.superview.frame.origin.y-b.frame.size.height, btn.size.width, 0);
            self.layer.shadowOffset = CGSizeMake(-5, -5);
        }else if ([direction isEqualToString:@"down"]) {
            self.frame = CGRectMake(btn.origin.x, b.superview.superview.frame.origin.y+b.frame.size.height, btn.size.width, 0);
            NSLog(@"%f%f",btn.origin.x,b.superview.superview.frame.origin.y+b.frame.size.height);
            self.layer.shadowOffset = CGSizeMake(-5, 5);
        }
        ...
        table.frame = CGRectMake(b.frame.origin.x, b.superview.superview.frame.origin.y+b.frame.size.height+3, b.frame.size.width, 0);
        table.delegate = self;
...
-(void)hideDropDown:(UIButton *)b {
   ...
   table.frame = CGRectMake(b.frame.origin.x, b.superview.superview.frame.origin.y+b.frame.size.height+10, b.frame.size.width, 0);
    [UIView commitAnimations];
}
